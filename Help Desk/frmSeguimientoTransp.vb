Public Class frmSeguimientoTransp
    ...
    Sub ActualizaGrid()
        Try
            ...
            If cmbIdEstatus.Text = 0 Then
                ...
                & " FROM TRANSP_SOLICITUDES HS, HELP_DEPARTAMENTOS HD, HELP_ESTATUS HE" _
    ...
    Private Sub DG_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DG.CellClick
        ...
        Try
            ...
            If Not DG.CurrentRow.IsNewRow Then
                ...
                StrSql = "SELECT CHOFER_ASIGNADO, FECHA_ASIGNACION, HORA_ASIGNACION, FECHA_CIERRE," _
                & "FECHA_SOLUCION, HORA_SOLUCION, COMENTARIO_DEPARTAMENTO FROM TRANSP_SOLICITUDES WHERE ID =" & Id
                objCmd = New SqlClient.SqlCommand(StrSql, Cnn)
                objReader = objCmd.ExecuteReader
                If objReader.HasRows Then
                    objReader.Read()
                    If Not String.IsNullOrEmpty(objReader("chofer_asignado")) Then
                        CA = objReader("chofer_asignado")
                    End If

                    If Not String.IsNullOrEmpty(objReader("fecha_asignacion").ToString) Then
                        If Len(objReader("fecha_asignacion").ToString) > 0 Then
                    ...
                    If Not String.IsNullOrEmpty(objReader("hora_asignacion").ToString) Then
                        If Len(objReader("hora_asignacion").ToString) > 0 Then
